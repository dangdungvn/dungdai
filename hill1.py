...
for i in range(0, len(s), 2):
    if s[i].isalpha():
        so3 = (((ord(s[i]) - 65) * k[0][0] +
               (ord(s[i+1]) - 65) * k[1][0]) % 26)
        so4 = (((ord(s[i]) - 65) * k[0][1] +
               (ord(s[i+1]) - 65) * k[1][1]) % 26)
        t = " " + str(so3) + " " + str(so4)
    b += t
...
for i in range(0, len(s), 2):
    if s[i].isalpha():
        ktmh1 = chr(
            (((ord(s[i]) - 65) * k[0][0] + (ord(s[i+1]) - 65) * k[1][0]) % 26) + 65)
        ktmh2 = chr(
            (((ord(s[i]) - 65) * k[0][1] + (ord(s[i+1]) - 65) * k[1][1]) % 26) + 65)
        t = ktmh1+ktmh2
    c += t
...
for i in range(0, len(c), 2):
    if c[i].isalpha():
        ktmh1 = chr(
            (((ord(c[i]) - 65) * kgm[0][0] + (ord(c[i+1]) - 65) * kgm[1][0]) % 26) + 65)
        ktmh2 = chr(
            (((ord(c[i]) - 65) * kgm[0][1] + (ord(c[i+1]) - 65) * kgm[1][1]) % 26) + 65)
        t = ktmh1+ktmh2
    g += t
